...
{
    public partial class cartIte : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Delivery within 5-7 business days", "Standard Shipping", 500.00m });

            migrationBuilder.InsertData(
                table: "ShippingMethods",
                columns: new[] { "Id", "Description", "Name", "Price" },
                values: new object[] { 2, "Delivery within 2-3 business days", "Express Shipping", 700.00m });
        }
